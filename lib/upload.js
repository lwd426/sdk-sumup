...
var YAML = require('yamljs').load(path.join(__dirname, 'config.yml'));
...
module.exports = function() {
  ...
  var child = exec(dosth, function (err, stdout, stderr) {
    ...
    exec(dosth2, function (err2, stdout2, stderr2) {
      console.log("git提交日志: " + stdout2);
      console.log("git提交结果: " + stderr2);
      if (err2) return false;
      console.log("=>sdk已经提交到git，请使用上线工具上线到测试机或生产环境".green);
      console.log("=>上线工具地址请看相关文档".green);
      console.log("=>如有权限问题,请联系相关人员".green);
    });
  });
}
